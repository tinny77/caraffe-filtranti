	...
	return (
		<div className="intro max-w-6xl mx-auto text-center text-5xl mb-10">
			...
			<Typography variant="lead">
				...
				<br />
				Vuoi comparare velocemente le opzioni disponibili e capire in un attimo
				se conviene o meno?
				<br />
				<br />
				Qui hai una selezione di caraffe filtranti disponibili sul mercato e
				puoi confrontare le varie opzioni.
				<br />
				Inoltre, trovi un comodo link per l'acquisto su Amazon, che garantisce
				un processo di acquisto sicuro e affidabile.
			</Typography>
			<Typography variant="lead" className="mt-10">
				...
				acqua naturale, senza impazzire nel calcolo del costo dei filtri in base
				ai tuoi consumi.
